  ...
  <div class="purchase">
    <el-card class="purchase-hd" shadow="never">
      ...
      <el-form :model="queryForm" ref="queryForm" inline class="query-form">
        ...
        <el-form-item label="咖啡编号：" prop="productNo">
          <el-input v-model="queryForm.productNo" @keyup.enter.native="queryPurchase" placeholder="咖啡编号"></el-input>
        </el-form-item>
    ...
    <el-card class="purchase-box" shadow="never">
      ...
      <el-table :data="purchaseData" class="type-table" height="425"  border style="width: 100%;user-select: text">
        ...
        <el-table-column label="咖啡编号" width="140">
          <template slot-scope="scope" >
            <el-tooltip class="item" effect="dark" v-if="purchaseData" placement="right"
                        :content="'咖啡名称：'+purchaseData[scope.$index].productName">
    ...
    <el-dialog title="采购信息" class="chang-purchase" :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="800px" center>
      <el-form class="info-form" inline :model="alterForm" ref='changeFrom'>
        ...
        <el-form-item label="咖啡编号：" prop="productNo">
          <el-input size="small" readonly v-model="alterForm.productNo" placeholder="咖啡编号"></el-input>
        </el-form-item>
        <el-form-item label="咖啡名称：" prop="productName">
          <el-input size="small" readonly v-model="alterForm.productName" placeholder="咖啡名称"></el-input>
        </el-form-item>
...
export default {
  ...
  methods:{
    ...
    receipts(index){
      ...
      let productNo = this.purchaseData[index].productNo;  //咖啡编号
      let purchaseId = this.purchaseData[index].purchaseId;
      this.$confirm('请核对咖啡名称及咖啡数量是否正确', '提示', {confirmButtonText: '收货', cancelButtonText: '取消', type: 'warning'}).then(() => {
