  ...
  <div class="slide-show">
    <el-card class="slideshow-hd" shadow="never">
      ...
      <el-form :model="productNameForm" ref="productNameForm" inline class="query-form">
        <el-form-item label="输入搜索：" prop="key">
          <el-input v-model="productNameForm.key" @keyup.enter.native="queryProductName" clearable placeholder="咖啡名称"></el-input>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card class="slideshow-box" shadow="never">
      ...
      <el-table :data="slideShow" class="type-table" height="425"  border style="width: 100%">
        ...
        <el-table-column prop="productName" label="咖啡名称" width="300"></el-table-column>
        ...
        <el-table-column label="咖啡链接" align="center" width="400">
          <template slot-scope="scope">
            <el-tooltip v-if="scope.row.productUrl" class="item" effect="dark" placement="bottom"
                        :content="scope.row.productUrl">
              <el-link type="warning" :href="scope.row.productUrl"><i class="el-icon-view el-icon--right"/> 查看咖啡</el-link>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    <el-dialog title="编辑咖啡轮播图信息" class="chang-product" :close-on-click-modal="false" :visible.sync="dialogFormVisible" center>
      <el-form class="info-form" inline :rules="alterRules" :model="alterForm" ref='changeFrom'>
        <el-form-item label="咖啡名称：" prop="productName" style="width: 100%">
          <el-input size="small" v-model="alterForm.productName" placeholder="咖啡名称"></el-input>
        </el-form-item>
        <el-form-item label="咖啡链接：" prop="productUrl" style="width: 100%">
          <el-input size="small" autosize v-model="alterForm.productUrl" placeholder="咖啡购买页链接"></el-input>
        </el-form-item>
        <el-form-item label="咖啡宣传图" prop="bannerUrl" style="">
          <el-upload
      ...
      data(){
        return{
          ...
          alterRules:{
            ...
            productUrl: [{ required: true, message: '请输入咖啡购买页面链接', trigger: 'blur' },
              { min: 1, max: 100, message: '咖啡链接长度不允许超过 200 个字符', trigger: 'blur' }],
